      ...
      : (
        <div>
          ...
          <form onSubmit={this.handleSubmit.bind(this)}>
            ...
            <button className={packagestatus === 1 ? "packageSelected" : "packageNormal"} id="type1" number="1" type="button" value="6-cylinder" onClick={(e) => this.buttonHandler(1, e, setProductOption)}>
            ...
            <button className={packagestatus === 2 ? "packageSelected" : "packageNormal"} id="type1" number="2" type="button" value="12-cylinder" onClick={(e) => this.buttonHandler(2, e, setProductOption)}>
